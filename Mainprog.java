...
public class Mainprog {
   ...
   private final String FilePath; // Making FilePath immutable
    /**
     * Parameterized constructor of class Mainprog
     * @param String 
     * 
     * 
     */
    Mainprog(String path) throws JSONException {
        FilePath = path;
    ...
    /**
     * Default constructor of class Mainprog
     * 
     * 
     * 
     */
    Mainprog() throws JSONException {
        FilePath = "D://Mainprog.JSON";
        JSONObject fill = new JSONObject();
        fill.put(" ", " ");      //Fill JSONobject with dummy value
         try (FileWriter file = new FileWriter(FilePath,false))
        		{
